...
class BuildDistOSX(bdist):
    ...
    description = 'create a OS X distribution package'
    user_options = [
        ('keep-temp', 'k',
    ...
    def _prepare_pgk_base(self, template_name, root='', gpl=True):
        ...
        if gpl:
            copy_file_src_dst += [
                (os.path.join(os.getcwd(), "README"),
                 os.path.join(osx_pkg_resrc, "ReadMe.txt")),
                (os.path.join(os.getcwd(), "COPYING"),
                 os.path.join(osx_pkg_resrc, "License.txt"))
            ]
        else:
            copy_file_src_dst += [
                (os.path.join(os.getcwd(), "README_com.txt"),
                 os.path.join(osx_pkg_resrc, "ReadMe.txt")),
                (os.path.join(os.getcwd(), "LICENSE_com.txt"),
                 os.path.join(osx_pkg_resrc, "License.txt"))
            ]
