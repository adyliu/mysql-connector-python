...
class MySQLConverterTests(tests.MySQLConnectorTests):
    ...
    def test_to_python(self):
        ...
        data = (
            (b'3.14', ('float', constants.FieldType.FLOAT)), #, None, None, None, None, True, constants.FieldFlag.NUM),
            ...
            (b'val1,val2', ('set', constants.FieldType.SET, None, None, None, None, True, constants.FieldFlag.SET)),
            (b'\xc3\xa4 utf8 string', ('utf8', constants.FieldType.STRING, None, None, None, None, True, 0)),
    ...
    def test__BIT_to_python(self):
        ...
        for i,d in enumerate(data):
            self.assertEqual(self.cnv._BIT_to_python(d),exp[i])
